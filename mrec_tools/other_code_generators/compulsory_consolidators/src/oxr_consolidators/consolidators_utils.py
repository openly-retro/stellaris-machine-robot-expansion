...
""" We have 3 'names' to keep track of:
1 - what is the common name for the resource
2 - what is the name of the resource in terms of how it is in deposit name
3 - the full slug of the resource, defined in 00_strategic_resources.txt
"""
