...
oxr_mdlc_councilor_editor_regulatory_leader_trait_army_veteran_2_add_button_effect = {
	potential = {
		event_target:oxr_mdlc_councilor_editor_target_@root = { NOT = { has_trait = leader_trait_army_veteran_2 } }
	}
	allow = {
...
oxr_mdlc_councilor_editor_regulatory_leader_trait_army_veteran_2_remove_button_effect = {
	potential = {
		event_target:oxr_mdlc_councilor_editor_target_@root = { has_trait = leader_trait_army_veteran_2 }
	}
	allow = { always = yes }
	effect = {
...
oxr_mdlc_councilor_editor_legion_leader_trait_armada_logistician_3_add_button_effect = {
	potential = {
		event_target:oxr_mdlc_councilor_editor_target_@root = { NOT = { has_trait = leader_trait_armada_logistician_3 } }
	}
	allow = {
...
oxr_mdlc_councilor_editor_legion_leader_trait_armada_logistician_3_remove_button_effect = {
	potential = {
		event_target:oxr_mdlc_councilor_editor_target_@root = { has_trait = leader_trait_armada_logistician_3 }
	}
	allow = { always = yes }
	effect = {
