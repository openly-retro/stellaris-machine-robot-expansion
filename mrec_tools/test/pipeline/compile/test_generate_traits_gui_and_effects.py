...
xvcv_mdlc_core_modifying_traits_official_trait_ruler_feedback_loop_2_add_button_effect = {
    ...
    effect = {
        ...
        xvcv_mdlc_core_modifying_ruler_change_class_add_trait = { CLASS = official ID = trait_ruler_feedback_loop_2 }
        hidden_effect = { xvcv_mdlc_core_modifying_country_deduct_trait_costs_common = yes }
    }
}
...
xvcv_mdlc_core_modifying_traits_official_leader_trait_frontier_spirit_3_add_button_effect = {
    ...
    allow = {
        ...
        xvcv_mdlc_core_modifying_ruler_check_trait_points_cost_veteran = yes
    ...
    effect = {
        ...
        xvcv_mdlc_core_modifying_ruler_change_class_add_trait = { CLASS = official ID = leader_trait_frontier_spirit_3 }
...
xvcv_mdlc_core_modifying_traits_official_leader_trait_frontier_spirit_3_remove_button_effect = {
    ...
    effect = {
        ...
        hidden_effect = {
            ...
            xvcv_mdlc_core_modifying_ruler_refund_trait_points_picks_veteran = yes
        }
    }
}
"""
...
xvcv_mdlc_core_modifying_traits_commander_leader_trait_bellicose_add_button_effect = {
    ...
    allow = {
        ...
        xvcv_mdlc_core_modifying_ruler_check_trait_points_cost_paragon = yes
        xvcv_mdlc_core_modifying_trait_skill_level_paragon_trigger = yes
        xvcv_mdlc_core_modifying_ruler_check_trait_picks = yes
        has_paragon_dlc = yes
    }
    effect = {
        xvcv_mdlc_core_modifying_ruler_change_class_add_trait = { CLASS = commander ID = leader_trait_bellicose }
...
xvcv_mdlc_core_modifying_traits_commander_leader_trait_bellicose_remove_button_effect = {
    ...
    effect = {
        ...
        hidden_effect = {
            ...
            xvcv_mdlc_core_modifying_ruler_refund_trait_points_picks_paragon = yes
        }
    }
}
"""
...
xvcv_mdlc_core_modifying_traits_official_leader_trait_efficient_add_button_effect = {
    ...
    effect = {
        xvcv_mdlc_core_modifying_ruler_change_class_add_trait = { CLASS = official ID = leader_trait_efficient }
        hidden_effect = { xvcv_mdlc_core_modifying_deduct_cost_points_picks_paragon = yes }
    }
}
