...
from mre_code_tools.pipeline.mre_common_vars import AUTOGENERATED_HEADER, INPUT_FILES_FOR_CODEGEN, LEADER_CLASSES, LEADER_SUBCLASSES, RARITIES, TRAITS_REQUIRING_DLC, TRAITS_REQUIRING_ORIGINS
