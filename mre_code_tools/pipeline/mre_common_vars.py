...
VANILLA_LOC_FILES_WITH_UPPERCASE_MODIFIERS = [
    ...
    "astral_planes_l_english",
    "cosmic_storms_l_english",
...
DEFAULT_UPPERCASE_MODIFIERS_MAP_FILES = [
    os.path.join(BUILD_FOLDER, basegamefile+"_upper.json")
    for basegamefile in VANILLA_LOC_FILES_WITH_UPPERCASE_MODIFIERS
]

DEFAULT_UPPERCASE_MODIFIERS_MEGAMAP = os.path.join(
    BUILD_FOLDER, "oxr_mdlc_pipeline_uppercase_megamap.json"
)

DEFAULT_UPPERCASE_LOCALISATION_MEGAMAP = os.path.join(
    'localisation','english','oxr_mdlc_l_english_uppercase_modifiers_map.yml'
)
...
TOOLTIP_LOOKUP_MAP = {
    ...
    "mod_federation_naval_cap_contribution_mult": "MOD_COUNTRY_FEDERATION_NAVAL_CAP_CONTRIBUTION_MULT",
}
...
MOD_BUTTON_EFFECTS_FOLDER = os.path.join(
    os.getcwd(),
