...
xvcv_mdlc_core_modifying_traits_{leader_class}_{trait_name}_add_button_effect = {{
    potential = {{ ruler = {{ NOT = {{ has_trait = {trait_name} }} }} }}
    allow = {{
    ...
    effect = {{
        {needs_remove_tier_num_trait_effect} xvcv_mdlc_core_modifying_remove_tier_1_or_2_traits_effect = {{ ID = {trait_name} }}
...
xvcv_mdlc_core_modifying_traits_{leader_class}_{trait_name}_remove_button_effect = {{
    potential = {{
        has_paragon_dlc = {has_paragon_dlc_answer}
