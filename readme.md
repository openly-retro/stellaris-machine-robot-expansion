...
- Council agendas for machine empires; some dont require an AP, others are AP-specific. I feel there is a big lack of council agendas for gestalts. Why not:
    - raw resources boost agenda: 2%/8%
    - alloys boost agenda
    - colony development : building + planetary speed boost 10%/30%
    - First contact focus : 50% faster first contact/80%
    - Cosmic microwave radiation scan: sensor range +1/+3

New ruler-only traits: (called "positronic modules"). GESTALT ONLY
    - Fractal waveform analysis module: sensor range ++
        "The machine intelligence dedicates some of its resources to studying common energy signatures across different scales."
    - Tesselation storage algorithms: resource storage +75% capacity, -1% energy
        "The machine intelligence dedicates resources to constantly calculating the highest efficiency resource storage subroutines."
    - Large-model transportation meshnet: 20% sublight speed, +5% ship energy cost, -5% ship energy upkeep
        "The machine intelligence utilizes peer-to-peer flight routines in favor of centralized propulsion calculations, and offloads certain computations to the individual ships" 
    - Deferred worker initialization: Unemployed machine pops dont destabilize planets
        "The machine intelligence forces unoccupied members into sleep mode to await further instructions"
    - Enhanced personality module: +15 trust cap, +20% trust growth, slightly more favorable overall
    - Artificial soul simulator: -20 gas, -20 motes, -2 dark matter, -1 living metal
        "Other empires no longer regard us as soulless machines."
        - require an artifact
        - if artifact destroyed/lost, event to remove this trait
    - Research core overclocking: 10% researcher output, +20% researcher upkeep, -1% energy
        "The machine intelligence directs extra power to all research units"
    - Triple-redundant leader microkernels: Leaders dont get negative traits (-5 negative trait), 50% leader upkeep, +10 energy upkeep per leader
        "The machine intelligence expends resources maintaining self-healing microkernel processes for all leaders. This greatly reduces errors normally caused by monolithic leader kernels."

New Ruler-only traits: "Racks" (non-gestalt-compatible machine traits)

Special project:
    - Artificial soul simulator, unlocks special ruler trait
      A fun sequence of events which are humorous
        - Do synthetic shells hallucinate about fleece-bearing quadrupeds?
            harvest some sheep from a temperate world inhabited by organics
        - The God Detection Project, Phase 1
            special project at asteroid field
            special project at sun
            gas giant
            special project at quasar
            special project at black hole
            2x archaeology sites OR
            1x archaeology and 1x Rift
        - Phase 2: Construct God Detector Array
            Perhaps our instruments are not powerful enough
            Special project at moon/asteroid, construction ship needed
            completion spawns "God detector" mining station. Produces 4 unity.
            "We can now plant God detectors across the galaxy"
            build 4 God-detectors
        - Compute Salvation
            "Our detection array picked up fluctuations of an unknown origin from [spiritualist empire]. We will proceed there and send an emissary in advance."
                - Spiritualists open communications
                - "Most holiest of greetings to you, [empire]. We would not have thought you would ever have an interest in our customs, much less in search of your souls. Although we fundamentally do not believe that machines have souls, the Almighty works in mysterious ways. It proves our faith and trust in you as a galactic neighbor was not misplaced. For us, this is a great omen."
                - We attend their feast. The food is completely tasteless. As we have no taste buds. We try their customs. They invite us to their libraries and temples for further study.
                \spiritualist gets favorable opinion modifier of the player: so this modifier is seeon on the "their opinion of us" part: --> "Spiritualist colonizer" +500 opinion, which goes away after the project is completed
            special project at spiritualist empire
            "our logic machines failed to detect any GOD particles in the books regarded by [empire]. Err: null pointer Source.Author not found! However after prolonged exposure, our language models have been updated to sufficiently imitate the behavior and speech mannerisms of the spiritualists."
            Empire modifier: "Pseudo-supplicant: +100 relation with all spiritualist empires"
            Project complete: Does not compute.
        - Self-worth parameters
            Perhaps the machine collective does not possess sufficient value to the "GOD". Perhaps we are too powerful and too intelligent for the G.O.D. to establish communications. We will attempt to weaken ourselves to appear sufficiently deserving.
            Ghost Output Datagram
            -10% resources for 6 mo
        - Love parameter analysis
            We are switching our spirituali subroutine generation sources. Instead of studying spirituality which attempts to colonize the meat-brain, we are beginning study of spiritualities which 
        - Results inconclusive
            modifiers removed
        - Communication received
            = G.O.D. is.
            - you are a datagram in our network. datagrams are not sapient. G.O.D. identifier not known. Expand identifier and explain why communications were initiated.
            = Ghost Output Datagram is --- Obj ref error, line 840: cannot reference variable 'self' before declaration. Packet transfer energy expired. End communications
        - Analyze communication aberration
            We discover no cause for the anomaly. However, our updated Spiritualist learning algorithms suggest the meaningless encounter was a sign of some sort.
            We further analyze the telemetry. The packet was not flawed. It was possibly an emergent property of our recent experiments. That our machine intelligence was able to produce a unique anomaly is conclusive evidence of the superiority of our reasoning.
            We produced it. It is beautiful. We are beautiful.
            Breakthrough acquired
            "Soul" definition updated in the empire's databanks
        - Manufacture false soul
            Special project. 500 gas, 500 motes, 500 dark matter, 10 living metal
        - Artifact acquired
            False soul: Passive +30 trust cap, Unlocks "Artificial Soul Simulator" ruler trait
            Active effect: +100 opinion with other contacted empires, except purifiers
            

- Make a Synthetic Dawn-only compatible version, absolute bare minimum of DLC requirements
    - select from non-paragon-dlc-requiring traits, "vanilla" subclasses
    - put paragon-dlc traits after regular ones

## Other wild ideas IDK if it can be done

- spread triggers and effects over days so as not to choke CPU in one single day .. maybe use events to trigger calculations, that then trigger the next event which happens in one day, etc
- detailed empire expenditures and bonuses, show researcher upkeep, drone upkeep, etc